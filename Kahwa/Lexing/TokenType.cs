...
namespace Kahwa.Lexing
{
    public enum TokenType
    {
        ...
        COMMA, DOT, APOSTROPHE, QUOTE, COLON, SEMICOLON,                          // ,      .     '      "     :    ;                   
        EOL,                                                                      // \n
        IDENTIFIER, INTEGER_LIT, DOUBLE_LIT, STRING_LIT, CHAR_LIT, BOOLEAN_LIT,   // baz    12    2.36   "yep" 'a'  true
        IN, FOR, RETURN, IF, ELSE, ELIF, WHILE, BREAK, CONTINUE, CAST, FUN,       // in     for   return if    else elif  while break  continue cast fun
